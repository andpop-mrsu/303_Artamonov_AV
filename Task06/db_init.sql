...
(
    ...
    secondName    varchar(100) check ( length(secondName) > 0),
...
select 1303                                                                                          as studentTicket,
       ...
       (select genders.id from genders where genders.genderName = 'Male')                            as genderId,
...
select 1204                                                                                          as studentTicket,
       ...
       (select genders.id from genders where genders.genderName = 'Female')                          as genderId,
